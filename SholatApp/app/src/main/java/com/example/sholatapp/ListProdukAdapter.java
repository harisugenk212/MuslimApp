...
public class ListProdukAdapter extends RecyclerView.Adapter<ListProdukAdapter.ProdukHolder>
        {
            ...
            @NonNull
            @Override
            public ProdukHolder onCreateViewHolder(@NonNull ViewGroup parent, int position) {
            ...
            @Override
            public void onBindViewHolder(@NonNull ProdukHolder produkHolder, int position) {
